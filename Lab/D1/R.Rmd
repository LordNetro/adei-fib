...
class(bmw$year)
class(bmw$price)
class(bmw$transmission)
class(bmw$mileage)
class(bmw$fuelType)
class(bmw$tax)
class(bmw$mpg)
class(bmw$engineSize)
```
...
new_mpg <- cut(bmw$mpg, breaks = breaksmpg, labels = labelsmpg)
summary(new_mpg)
...
new_engineSize <- cut(bmw$engineSize, breaks = breaksengineSize, labels = labelsengineSize)
...
new_year <- cut(as.numeric(bmw$year), breaks = breaksyear, labels = labelsyear)
...
new_price <- cut(as.numeric(bmw$price), breaks = breaksprice, labels = labelsprice)
summary(new_price)
...
new_mileage <- cut(as.numeric(bmw$mileage), breaks = breaksmileage, labels = labelsmileage)
summary(new_mileage)
...
new_tax <- cut(as.numeric(bmw$tax), breaks = breakstax, labels = labelstax)
summary(new_tax)
